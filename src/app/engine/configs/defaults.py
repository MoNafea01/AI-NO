...
MODELS = {
    ...
    'svc':{'node': SVC,'params': {'C': 1.0, 'kernel': 'rbf',}},
...
NETS = {
    ...
    'conv2d_layer': {'node': 'Conv2D', 'params': {'filters': 32, 'kernel_size': (3, 3), 'strides': (1, 1), 'padding': 'valid', 'activation': 'relu'}},
    'maxpool2d_layer': {'node': 'MaxPooling2D', 'params': {'pool_size': (2, 2), 'strides': (2, 2), 'padding': 'valid'}},
    ...
    'model_compiler': {'node': 'compile', 'params': {'optimizer': 'adam', 'loss': 'categorical_crossentropy', 'metrics': ['accuracy']}},
    'nn_fitter': {'node': 'fit', 'params': {'batch_size': 32, 'epochs': 10, 'validation_split': 0.2}},
}
