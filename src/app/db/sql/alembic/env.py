...
# Load .env file so os.environ sees POSTGRES_* variables (locally)
...
def get_database_url():
    """Build database URL from environment variables or fallback to alembic.ini"""
    host = os.environ.get("POSTGRES_HOST")
    port = os.environ.get("POSTGRES_PORT", "5432")
    db = os.environ.get("POSTGRES_MAIN_DB")
...
if not db_url:
    raise RuntimeError(
        "Database URL not configured. Set POSTGRES_HOST, POSTGRES_MAIN_DB, "
