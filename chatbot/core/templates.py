...
def get_template(mode):
    ...
    file_map = {
        'manual': config['templates']['manual'],
        'auto': config['templates']['auto'],
        'step': config['templates']['data_steps'],
        'router': config['templates']['router'],
        'selector': config['templates']['select_mode']
    }
