                ...
                if (state is ModelsLoading) {
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        ElevatedButton(
                          onPressed: () => context.read<ModelsCubit>().loadModels(),
                          child: const Text('إعادة المحاولة'),
                        ),
                      ],
                    ),
                  ...
                  return Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: modelsWithProjects.length,
                      itemBuilder: (context, index) {
                        final modelName = modelsWithProjects.keys.elementAt(index);
                        final projects = modelsWithProjects[modelName]!;
...
class ModelCard extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Company/Creator (you can customize this)
                Text(
                  'AI Model', // You can replace this with actual creator info if available
                  style: TextStyle(
                    fontSize: 12,
                    color: Colors.grey[600],
                  ),
                ...
                // Description (you can use first project's description or create a general one)
                Text(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${projects.length * 10}', // Mock download count
                        style: TextStyle(
                          fontSize: 12,
                          color: Colors.grey[600],
                        ),
                ...
                Row(
                  children: [
                    ...
                    // Arrow/Menu button
                    InkWell(
                      onTap: () => _showProjectsDialog(context, modelName, projects),
                      child: Container(
                        width: 24,
                        height: 24,
                        decoration: BoxDecoration(
  ...
  void _showProjectsDialog(BuildContext context, String modelName, List<ProjectModel> projects) {
    showDialog(
      context: context,
