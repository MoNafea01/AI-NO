...
#     sucess, payload = send_request_to_api(args, query, method_type='put', node_id=block_id, project_id=project_id)
#     if not isinstance(payload, dict):
...
#     sucess, payload = send_request_to_api(args, query, method_type='delete', node_id=block_id, project_id=project_id)
#     if not payload:
#         project.pop(i)
...
#     if not project_id:
#         project_id = get_data_store().get("active_project")
#     sucess, payload = send_request_to_api(args, query, method_type='get', node_id=block_id, project_id=project_id, output=out)
#     if not isinstance(payload, dict):
