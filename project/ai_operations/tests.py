...
class PipeLineTest(APITestCase):
    ...
    def test_08_clear_nodes(self, url='/api/clear_nodes/'):
        # Clear all nodes
...
class PipelineIntegrationTest(APITestCase):
    ...
    #     # Step 2.1 Split output to train and test sets
    #     url = reverse('splitter')
    #     data = {
    #         "data": X
    #     }
    #     response = self.client.post(url, data, format='json')
    ...
    #     print(self.client.get(url, query_params={"node_id":X_test, "return_data":1}))
