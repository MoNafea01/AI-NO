...
class NodeLoader:
        ...
        try:
            ...
            if path:
                try:
                    ...
                    return self.build_payload(node_data, node_name, node_id, project_id, path)
            ...
            return self.build_payload(node_data, node_entry.node_name, node_id, project_id, path)
    ...
    def build_payload(self, node_data, name, node_id, project_id, path) -> tuple[bool, dict] | tuple[bool, str]:
        try:
            if path:
                self.from_db = False
            payload = {
            ...
            return False, f"Error creating payload: {e}"
